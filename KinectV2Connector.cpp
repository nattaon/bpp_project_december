...
KinectV2Connector::KinectV2Connector()
{
    hResult = S_OK;
...
void KinectV2Connector::initialize_kinect()
{
...
int KinectV2Connector::openKinect()
{
	/*
...
*/
	...
	//isOpen always be "true" even kinect is not connect to pc!!!
	if (!isOpen)
	{
...
IColorFrameReader* KinectV2Connector::get_colorframereader()
{
...
IDepthFrameReader* KinectV2Connector::get_depthframereader()
{
	//// DO get depth image	
...
ICoordinateMapper* KinectV2Connector::get_coordinatemapper()
{
...
cv::Mat KinectV2Connector::get_colorframe(float COLORSCALE)
{
...
void KinectV2Connector::get_depthframe()
{
...
void KinectV2Connector::release_kinect()
{
